 ...
 */
#define E0_AUTO_FAN_PIN P2_04                                  // SKR14T
...
#define SET_PROGRESS_MANUALLY                              // DIGA-Tech:
  ...
  #define M73_REPORT                      // Report M73 values to host         // DIGA-Tech:
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_CONNECTION LCD                        // SKR14T
...
#define TX_BUFFER_SIZE 32                                  // DIGA-Tech:

// Host Receive Buffer Size
// Without XON/XOFF flow control (see SERIAL_XON_XOFF below) 32 bytes should be enough.
// To use flow control, set this buffer size to at least 1024 bytes.
// :[0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048]
#define RX_BUFFER_SIZE 128                                 // DIGA-Tech:
